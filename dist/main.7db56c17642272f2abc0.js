...
__webpack_require__.d(__webpack_exports__, {
  "default": function() { return /* reexport */ useMediaQuery; }
});
...
;// CONCATENATED MODULE: ./node_modules/@material-ui/core/esm/useMediaQuery/index.js
...
/* harmony export */   "authentification": function() { return /* binding */ authentification; },
...
var registration = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(login, password, handlerName) {
  ...
  return function registration(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
var authentification = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(login, password, handlerName) {
  ...
  return function authentification(_x4, _x5, _x6) {
    return _ref2.apply(this, arguments);
  };
}();
var logout = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(login, handlerName) {
...
var authorization = /*#__PURE__*/function () {
  ...
  return function authorization(_x9) {
...
/* harmony export */ });
/* harmony import */ var _DAL_authUsers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(970);
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
...
var SET_DISPLAY_LOADING_PAGE_STATUS = 'SET_DISPLAY_LOADING_PAGE_STATUS';
var DELETE_JWT_TOKEN = 'DELETE_JWT_TOKEN';
var initialState = {
  authStatus: false,
  mediaQuery: {
...
var setAuthStatusAC = function setAuthStatusAC(status) {
  return {
    type: SET_AUTH_STATUS,
    status: status
  };
};
var displayLoadingPageAC = function displayLoadingPageAC(status) {
  return {
...
var repeatedRequest = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0,_DAL_authUsers__WEBPACK_IMPORTED_MODULE_0__.authorization)(token);
  ...
  return function repeatedRequest(_x) {
    return _ref.apply(this, arguments);
  };
}();

var verifyUserTokenThunk = function verifyUserTokenThunk(token) {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return repeatedRequest(token);

            case 3:
              decoded = _context2.sent;

              if (decoded.data.errorMessage) {
                // ЕСЛИ ОШИБКА, errorMessage можно передать в обработчик ошибки
                dispatch(setAuthStatusAC(false));
                localStorage.clear();
                dispatch(displayLoadingPageAC(false));
              } else if (decoded.data.decodeUserData) {
                dispatch(setAuthStatusAC(true)); // для отображение в пропсах,чтобы смотреть что пришло
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "BrowserRouter": function() { return /* binding */ BrowserRouter; },
  "HashRouter": function() { return /* binding */ HashRouter; },
  "Link": function() { return /* binding */ Link; },
  "MemoryRouter": function() { return /* reexport */ MemoryRouter; },
  "NavLink": function() { return /* binding */ NavLink; },
  "Prompt": function() { return /* reexport */ Prompt; },
  "Redirect": function() { return /* reexport */ Redirect; },
  "Route": function() { return /* reexport */ Route; },
  "Router": function() { return /* reexport */ Router; },
  "StaticRouter": function() { return /* reexport */ StaticRouter; },
  "Switch": function() { return /* reexport */ Switch; },
  "generatePath": function() { return /* reexport */ generatePath; },
  "matchPath": function() { return /* reexport */ matchPath; },
  "useHistory": function() { return /* reexport */ useHistory; },
  "useLocation": function() { return /* reexport */ useLocation; },
  "useParams": function() { return /* reexport */ useParams; },
  "useRouteMatch": function() { return /* reexport */ useRouteMatch; },
...
var react_redux_1 = __webpack_require__(4494);
var redux_1 = __webpack_require__(8676);
var react_router_dom_1 = __webpack_require__(8923);
var useMediaQuery_1 = __importDefault(__webpack_require__(2969));
// import {Context} from '@babel/preset-typescript'
var appReducer_1 = __webpack_require__(2144);
__webpack_require__(2196);
var header_1 = __importDefault(__webpack_require__(402));
var login_1 = __importDefault(__webpack_require__(9646));
var registration_1 = __importDefault(__webpack_require__(8145));
var loadingpage_1 = __importDefault(__webpack_require__(2015));
var welbe_1 = __importDefault(__webpack_require__(8598));
var GoodsArrivals = react_1.default.lazy(function () { return Promise.resolve().then(function () { return __importStar(__webpack_require__(3191)); }); });
...
function App(props) {
    var queryParams = {
        widthForTransformHeader330: useMediaQuery_1.default(props.mediaQuery.widthForTransformHeader330),
        widthForTransformHeader530: useMediaQuery_1.default(props.mediaQuery.widthForTransformHeader530),
        widthForTransformHeader580: useMediaQuery_1.default(props.mediaQuery.widthForTransformHeader580),
        widthForTransformHeader700: useMediaQuery_1.default(props.mediaQuery.widthForTransformHeader700),
        widthForTransformHeader900: useMediaQuery_1.default(props.mediaQuery.widthForTransformHeader900),
    };
    ...
    return (react_1.default.createElement("div", { className: 'app' },
        react_1.default.createElement(header_1.default, { queryParams: queryParams }),
...
exports.default = redux_1.compose(react_redux_1.connect(mapStateToProps, {
    verifyUserTokenThunk: appReducer_1.verifyUserTokenThunk,
    displayLoadingPageAC: appReducer_1.displayLoadingPageAC
}))(App);
...
var GoodsArrivals = function (_a) {
    ...
    return (react_1.default.createElement("section", null,
        react_1.default.createElement("div", null,
            react_1.default.createElement("h1", null, "wwqw"))));
};
var mapStateToProps = function (state) {
    return {
        authStatus: state.appReducer.authStatus
...
exports.default = redux_1.compose(react_redux_1.connect(mapStateToProps, {}))(GoodsArrivals);
...
var menu_1 = __importDefault(__webpack_require__(1078));
var loginReducer_1 = __webpack_require__(7545);
var appReducer_1 = __webpack_require__(2144);
var Header = react_1.default.memo(function (_a) {
    var queryParams = _a.queryParams, navigationItems = _a.navigationItems, authStatus = _a.authStatus, logoutThunk = _a.logoutThunk, setAuthStatusAC = _a.setAuthStatusAC;
    var history = react_router_dom_1.useHistory();
    var _b = react_hook_form_1.useForm(), errors = _b.formState.errors, handleSubmit = _b.handleSubmit;
    var _c = react_1.useState(false), openMenu = _c[0], setOpenMenu = _c[1];
    var menuLinksClass = 'menu-container__button';
    var headerLinksClass = 'header__item';
    var createNavigationElements = function (amountElements, linkClass) {
        var links = __spreadArray([], navigationItems);
        links.splice(-amountElements, amountElements); // splice возвращает массив удаленных элементов
        return links.map(function (item) { return react_1.default.createElement(react_router_dom_1.NavLink, { to: item.link, className: "" + linkClass, key: item.name }, item.name); });
    };
    var getMenuElements = function (amountElements) {
        var links = __spreadArray([], navigationItems).splice(-amountElements, amountElements);
        return links.map(function (item) { return react_1.default.createElement(react_router_dom_1.NavLink, { to: item.link, className: 'menu-container__button', key: item.name }, item.name); });
    };
    var getHeaderElements = function (amountElements) {
        return createNavigationElements(amountElements, headerLinksClass);
    };
    var setAllLinksInMenu = function () {
        return navigationItems.map(function (item) { return react_1.default.createElement(react_router_dom_1.NavLink, { to: item.link, className: 'menu-container__button', key: item.name }, item.name); });
    };
    var getLengthMenuElements = function (valueQuery) {
        if (valueQuery === void 0) { valueQuery = 0; }
        var values = valueQuery;
        Object.values(queryParams).forEach(function (value) {
            if (value)
                values++;
        });
        console.log(values);
    ...
    // const menuHandler: { (event: MouseEvent): void } = (event:MouseEvent) => {
    //     event.preventDefault()
    //     openMenu ? setOpenMenu(false) : setOpenMenu(true)
    // }
    // useEffect(() => {
    //     const domElement = document.querySelector('.menu-container__menu-name')
    //     domElement.addEventListener('click' , menuHandler)
    ...
    return (react_1.default.createElement("header", { className: 'header' },
        react_1.default.createElement("nav", { className: 'header__navigation' },
            react_1.default.createElement("ul", { className: 'header__items' },
                !queryParams.widthForTransformHeader530 ? getHeaderElements(getLengthMenuElements()) : null,
                react_1.default.createElement(menu_1.default, { queryParams: queryParams }),
                react_1.default.createElement("div", { className: 'header__menu-block' },
                    authStatus ? react_1.default.createElement("button", { onClick: logout, className: 'header__button' }, "logout") : react_1.default.createElement(react_router_dom_1.NavLink, { className: 'header__button', to: '/login' }, "login"),
                    react_1.default.createElement(react_router_dom_1.NavLink, { to: '/settings', className: 'header__button' }, "\u041D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0438"),
                    react_1.default.createElement(react_router_dom_1.NavLink, { to: '/registration', className: 'header__button' }, "\u0420\u0435\u0433\u0438\u0441\u0442\u0440\u0430\u0446\u0438\u044F"),
...
exports.default = redux_1.compose(react_redux_1.connect(mapStateToProps, {
    logoutThunk: loginReducer_1.logoutThunk,
    setAuthStatusAC: appReducer_1.setAuthStatusAC
}))(Header);
...
var LoadingPage = function (_a) {
    var messageLoadingPage = _a.messageLoadingPage;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var react_1 = __importDefault(__webpack_require__(7294));
__webpack_require__(4306);
var redux_1 = __webpack_require__(8676);
var react_redux_1 = __webpack_require__(4494);
var react_router_dom_1 = __webpack_require__(8923);
var react_hook_form_1 = __webpack_require__(930);
var settings_validation_1 = __webpack_require__(4823);
var loginReducer_1 = __webpack_require__(7545);
var Login = function (props) {
    ...
    console.log(props);
    return (react_1.default.createElement("section", { className: 'login-container' },
        props.errorMessage ? react_1.default.createElement("span", { className: 'login-container__toast-errorMessage' },
            react_1.default.createElement("b", null, props.errorMessage)) : null,
        react_1.default.createElement("h1", { className: 'login-container__section-title' }, "\u0412\u0445\u043E\u0434"),
        react_1.default.createElement("div", { className: 'login-container__form-container' },
            react_1.default.createElement("form", { onSubmit: handleSubmit(authentification), className: 'login-form' },
                react_1.default.createElement("label", { className: 'login-form__label', htmlFor: 'login' }, "Login / \u041B\u043E\u0433\u0438\u043D"),
                react_1.default.createElement("input", __assign({ autoComplete: 'false', className: 'login-form__menu-item' }, register('login', { required: true, maxLength: settings_validation_1.settingsValidation.maxLenght, minLength: settings_validation_1.settingsValidation.minLenght }))),
                ((_a = errors.login) === null || _a === void 0 ? void 0 : _a.type) === 'maxLength' && react_1.default.createElement("p", null, "\u041C\u0430\u043A\u0441\u0438\u043C\u0430\u043B\u044C\u043D\u0430\u044F \u0434\u043B\u0438\u043D\u0430 \u043B\u043E\u0433\u0438\u043D\u0430 20 \u0441\u0438\u043C\u0432\u043E\u043B\u0430"),
                ((_b = errors.login) === null || _b === void 0 ? void 0 : _b.type) === 'minLength' && react_1.default.createElement("p", null, "\u041C\u0438\u043D\u0438\u0438\u043C\u0430\u043B\u044C\u043D\u0430\u044F \u0434\u043B\u0438\u043D\u0430 \u043B\u043E\u0433\u0438\u043D\u0430 5 \u0441\u0438\u043C\u0432\u043E\u043B\u043E\u0432"),
                ((_c = errors.login) === null || _c === void 0 ? void 0 : _c.type) === 'required' && react_1.default.createElement("p", null, "\u041E\u0431\u044F\u0437\u0430\u0442\u0435\u043B\u044C\u043D\u043E \u043F\u043E\u043B\u0435"),
                react_1.default.createElement("label", { className: 'login-form__label', htmlFor: "password" }, "Password / \u041F\u0430\u0440\u043E\u043B\u044C"),
                react_1.default.createElement("input", __assign({ autoComplete: 'false', type: 'password', className: 'login-form__menu-item' }, register('password', { required: true, maxLength: settings_validation_1.settingsValidation.maxLenght, minLength: settings_validation_1.settingsValidation.minLenght }))),
                ((_d = errors.password) === null || _d === void 0 ? void 0 : _d.type) === 'maxLength' && react_1.default.createElement("p", null, "\u041C\u0430\u043A\u0441\u0438\u043C\u0430\u043B\u044C\u043D\u0430\u044F \u0434\u043B\u0438\u043D\u0430 \u043B\u043E\u0433\u0438\u043D\u0430 20 \u0441\u0438\u043C\u0432\u043E\u043B\u0430"),
                ((_e = errors.password) === null || _e === void 0 ? void 0 : _e.type) === 'minLength' && react_1.default.createElement("p", null, "\u041C\u0438\u043D\u0438\u0438\u043C\u0430\u043B\u044C\u043D\u0430\u044F \u0434\u043B\u0438\u043D\u0430 \u043B\u043E\u0433\u0438\u043D\u0430 5 \u0441\u0438\u043C\u0432\u043E\u043B\u043E\u0432"),
                ((_f = errors.password) === null || _f === void 0 ? void 0 : _f.type) === 'required' && react_1.default.createElement("p", null, "\u041E\u0431\u044F\u0437\u0430\u0442\u0435\u043B\u044C\u043D\u043E \u043F\u043E\u043B\u0435"),
...
exports.default = redux_1.compose(react_redux_1.connect(mapStateToProps, {
    loginThunk: loginReducer_1.loginThunk,
}))(Login);
...
var Menu = function (props) {
    var menuBlockHandler = function () {
        document.querySelector('.header__menu-block').classList.toggle('view');
    };
    return (React.createElement("div", { className: 'menu-container', onClick: menuBlockHandler },
        React.createElement("span", { className: 'menu-container__menu-name ' }, "\u041C\u0435\u043D\u044E")));
};
var mapStateToProps = function (state) {
    return {};
};
exports.default = redux_1.compose(react_redux_1.connect(mapStateToProps, {}))(Menu);
...
var Registration = function (props) {
    ...
    return (react_1.default.createElement("section", { className: 'login-container' },
        props.errorMessage ? react_1.default.createElement("span", { className: 'login-container__toast-errorMessage' },
            react_1.default.createElement("b", null, props.errorMessage)) : null,
        react_1.default.createElement("h1", { className: 'login-container__section-title' },
            " ",
            props.newUserLogin ? "\u0423\u0441\u043F\u0435\u0448\u043D\u0430\u044F \u0440\u0435\u0433\u0438\u0441\u0442\u0440\u0430\u0446\u0438\u044F \u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044F " + props.newUserLogin : 'Регистрация',
            " "),
        react_1.default.createElement("div", { className: 'login-container__form-container' },
            react_1.default.createElement("form", { onSubmit: handleSubmit(registrationHandler), className: 'login-form' },
                react_1.default.createElement("label", { className: 'login-form__label' }, "login / \u043B\u043E\u0433\u0438\u043D"),
                react_1.default.createElement("input", __assign({ autoComplete: 'false', className: 'login-form__menu-item' }, register('login', { required: true, maxLength: settings_validation_1.settingsValidation.maxLenght, minLength: settings_validation_1.settingsValidation.minLenght }))),
                ((_a = errors.login) === null || _a === void 0 ? void 0 : _a.type) === 'maxLength' && react_1.default.createElement("p", null, "\u041C\u0430\u043A\u0441\u0438\u043C\u0430\u043B\u044C\u043D\u0430\u044F \u0434\u043B\u0438\u043D\u0430 \u043B\u043E\u0433\u0438\u043D\u0430 20 \u0441\u0438\u043C\u0432\u043E\u043B\u0430"),
                ((_b = errors.login) === null || _b === void 0 ? void 0 : _b.type) === 'minLength' && react_1.default.createElement("p", null, "\u041C\u0438\u043D\u0438\u0438\u043C\u0430\u043B\u044C\u043D\u0430\u044F \u0434\u043B\u0438\u043D\u0430 \u043B\u043E\u0433\u0438\u043D\u0430 6 \u0441\u0438\u043C\u0432\u043E\u043B\u0430"),
                ((_c = errors.login) === null || _c === void 0 ? void 0 : _c.type) === 'required' && react_1.default.createElement("p", null, "\u041E\u0431\u044F\u0437\u0430\u0442\u0435\u043B\u044C\u043D\u043E \u043F\u043E\u043B\u0435"),
                react_1.default.createElement("label", { className: 'login-form__label', htmlFor: "password" }, "password / \u043F\u0430\u0440\u043E\u043B\u044C"),
                react_1.default.createElement("input", __assign({ autoComplete: 'false', type: 'password', className: 'login-form__menu-item' }, register('password', { required: true, maxLength: settings_validation_1.settingsValidation.maxLenght, minLength: settings_validation_1.settingsValidation.minLenght }))),
                ((_d = errors.password) === null || _d === void 0 ? void 0 : _d.type) === 'maxLength' && react_1.default.createElement("p", null, "\u041C\u0430\u043A\u0441\u0438\u043C\u0430\u043B\u044C\u043D\u0430\u044F \u0434\u043B\u0438\u043D\u0430 \u043B\u043E\u0433\u0438\u043D\u0430 20 \u0441\u0438\u043C\u0432\u043E\u043B\u0430"),
                ((_e = errors.password) === null || _e === void 0 ? void 0 : _e.type) === 'minLength' && react_1.default.createElement("p", null, "\u041C\u0438\u043D\u0438\u0438\u043C\u0430\u043B\u044C\u043D\u0430\u044F \u0434\u043B\u0438\u043D\u0430 \u043B\u043E\u0433\u0438\u043D\u0430 6 \u0441\u0438\u043C\u0432\u043E\u043B\u0430"),
                ((_f = errors.password) === null || _f === void 0 ? void 0 : _f.type) === 'required' && react_1.default.createElement("p", null, "\u041E\u0431\u044F\u0437\u0430\u0442\u0435\u043B\u044C\u043D\u043E \u043F\u043E\u043B\u0435"),
...
exports.default = redux_1.compose(react_redux_1.connect(mapStateToProps, {
    registrationThunk: loginReducer_1.registrationThunk,
}))(Registration);
...
var Welbe = function (_a) {
    var data = _a.data;
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("table", null,
            react_1.default.createElement("thead", null,
                react_1.default.createElement("tr", null,
                    react_1.default.createElement("th", null, "\u0414\u0430\u0442\u0430"),
                    react_1.default.createElement("th", null, "\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435"),
                    react_1.default.createElement("th", null, "\u041A\u043E\u043B\u0438\u0447\u0435\u0441\u0442\u0432\u043E"),
                    react_1.default.createElement("th", null, "\u0420\u0430\u0441\u0441\u0442\u043E\u044F\u043D\u0438\u0435"))),
...
exports.default = redux_1.compose(react_redux_1.connect(mapStateToProps, {}))(Welbe);
...
var app_1 = __importDefault(__webpack_require__(7874));
var store_1 = __importDefault(__webpack_require__(9744));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getNavigationItemAC = void 0;
var GET_NAVIGATION_ITEM = 'GET_NAVIGATION_ITEM';
var initialState = {
    navItems: [
        {
...
var getNavigationItemAC = function () {
    return {
        type: GET_NAVIGATION_ITEM,
    };
};
exports.getNavigationItemAC = getNavigationItemAC;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.registrationThunk = exports.logoutThunk = exports.loginThunk = exports.viewUserDataAC = exports.showErrorAC = exports.registrationAC = exports.logoutAC = exports.loginAC = void 0;
var authUsers_1 = __webpack_require__(970);
var appReducer_1 = __webpack_require__(2144);
var react_redux_1 = __webpack_require__(4494);
var LOGIN = 'LOGIN';
...
var LOGOUT = 'LOGOUT';
var VIEW_USER_DATA = 'VIEW_USER_DATA';
var initialState = {
    login: null,
    token: null,
    newUserLogin: null,
...
var loginReducer = function (state, action) {
    ...
    switch (action.type) {
        case LOGIN: {
            return __assign(__assign({}, state), { login: action.login, token: action.token });
        }
        case LOGOUT: {
            return __assign(__assign({}, state), { login: null, token: null });
        }
        case REGISTRATION: {
            return __assign(__assign({}, state), { newUserLogin: action.login });
        }
        case SHOW_ERROR: {
...
var loginAC = function (login, token) {
    return {
        type: LOGIN,
        login: login,
        token: token
...
var logoutAC = function () {
    return {
        type: LOGOUT,
    };
};
exports.logoutAC = logoutAC;
var registrationAC = function (login) {
    return {
        type: REGISTRATION,
        login: login,
    };
};
exports.registrationAC = registrationAC;
var showErrorAC = function (errorMessage) {
    return {
        type: SHOW_ERROR,
        errorMessage: errorMessage,
    };
};
exports.showErrorAC = showErrorAC;
var viewUserDataAC = function (data) {
    return {
        type: VIEW_USER_DATA,
        data: data
    };
};
exports.viewUserDataAC = viewUserDataAC;
var loginThunk = function (login, password) {
    return function (dispatch) { return __awaiter(void 0, void 0, void 0, function () {
        var loginRequest;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, authUsers_1.authentification(login, password, LOGIN)];
                case 1:
                    loginRequest = _a.sent();
                    if (loginRequest.data.errorMessage) {
                        dispatch(exports.showErrorAC(loginRequest.data.errorMessage));
                    }
                    else {
                        react_redux_1.batch(function () {
                            dispatch(exports.showErrorAC(null));
                            dispatch(exports.loginAC(loginRequest.data.login, loginRequest.data.token));
                            dispatch(appReducer_1.setAuthStatusAC(true));
                            dispatch(exports.viewUserDataAC(loginRequest.data));
                        });
...
var logoutThunk = function (userLogin) {
    return function (dispatch) { return __awaiter(void 0, void 0, void 0, function () {
        var logoutResponse;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, authUsers_1.logout(userLogin, LOGOUT)];
                case 1:
                    logoutResponse = _a.sent();
                    dispatch(exports.logoutAC());
                    return [2 /*return*/];
            }
        });
    }); };
...
var registrationThunk = function (login, password) {
    return function (dispatch) { return __awaiter(void 0, void 0, void 0, function () {
        var registrationResponse;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, authUsers_1.registration(login, password, REGISTRATION)];
                case 1:
                    registrationResponse = _a.sent();
                    if (registrationResponse.data.errorMessage) {
                        dispatch(exports.showErrorAC(registrationResponse.data.errorMessage));
                    }
                    else {
                        dispatch(exports.registrationAC(registrationResponse.data.newUserLogin));
                    }
                    return [2 /*return*/];
            }
        });
...
exports.registrationThunk = registrationThunk;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var redux_1 = __webpack_require__(8676);
var appReducer_1 = __importDefault(__webpack_require__(2144));
var headerReducer_1 = __importDefault(__webpack_require__(6243));
var loginReducer_1 = __importDefault(__webpack_require__(7545));
var redux_thunk_1 = __importDefault(__webpack_require__(3894));
var reducers = redux_1.combineReducers({
    appReducer: appReducer_1.default,
    headerReducer: headerReducer_1.default,
    loginReducer: loginReducer_1.default,
});
var store = redux_1.createStore(reducers, redux_1.applyMiddleware(redux_thunk_1.default));
