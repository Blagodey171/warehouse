...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "l9": function() { return /* binding */ registration; },
/* harmony export */   "p_": function() { return /* binding */ authentification; },
/* harmony export */   "jL": function() { return /* binding */ authorization; }
/* harmony export */ });
...
var authorization = /*#__PURE__*/function () {
  ...
  return function authorization(_x7) {
...
var USER_TOKEN_STATUS = 'USER_TOKEN_STATUS';
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0,_DAL_authUsers__WEBPACK_IMPORTED_MODULE_0__/* .authorization */ .jL)(token);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getNavigationItemAC": function() { return /* binding */ getNavigationItemAC; }
/* harmony export */ });
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }
...
var getNavigationItemAC = function getNavigationItemAC() {
  return {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "loginAC": function() { return /* binding */ loginAC; },
/* harmony export */   "logoutAC": function() { return /* binding */ logoutAC; },
/* harmony export */   "registrationAC": function() { return /* binding */ registrationAC; },
/* harmony export */   "showErrorAC": function() { return /* binding */ showErrorAC; },
/* harmony export */   "authentificationThunk": function() { return /* binding */ authentificationThunk; },
/* harmony export */   "registrationThunk": function() { return /* binding */ registrationThunk; }
/* harmony export */ });
/* harmony import */ var _DAL_authUsers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(970);
/* harmony import */ var _appReducer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2144);
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4494);
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
...
var loginAC = function loginAC(login, token) {
  return {
    type: LOGIN,
    login: login,
    token: token
...
var registrationAC = function registrationAC(login) {
  return {
    type: REGISTRATION,
    login: login
  };
};
var showErrorAC = function showErrorAC(errorMessage) {
  return {
    type: SHOW_ERROR,
    errorMessage: errorMessage
  };
};
var authentificationThunk = function authentificationThunk(login, password) {
  return /*#__PURE__*/function () {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return (0,_DAL_authUsers__WEBPACK_IMPORTED_MODULE_0__/* .authentification */ .p_)(login, password, LOGIN);
            ...
            case 2:
              ...
              if (loginRequest.data.errorMessage) {
                ...
                (0,react_redux__WEBPACK_IMPORTED_MODULE_2__.batch)(function () {
                  dispatch(showErrorAC(null));
                  dispatch(loginAC(loginRequest.data.login, loginRequest.data.token));
                  dispatch((0,_appReducer__WEBPACK_IMPORTED_MODULE_1__.setAuthStatusAC)(true));
                });
...
var registrationThunk = function registrationThunk(login, password) {
  return /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(dispatch) {
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return (0,_DAL_authUsers__WEBPACK_IMPORTED_MODULE_0__/* .registration */ .l9)(login, password, REGISTRATION);
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "default": function() { return /* binding */ redux_store; }
});

// EXTERNAL MODULE: ./node_modules/redux/es/redux.js + 2 modules
var redux = __webpack_require__(8676);
// EXTERNAL MODULE: ./src/redux/appReducer.js
var appReducer = __webpack_require__(2144);
// EXTERNAL MODULE: ./src/redux/headerReducer.js
var headerReducer = __webpack_require__(3659);
// EXTERNAL MODULE: ./src/redux/loginReducer.js
var loginReducer = __webpack_require__(8590);
...
var reducers = (0,redux.combineReducers)({
  appReducer: appReducer.default,
  headerReducer: headerReducer.default,
  loginReducer: loginReducer.default
});
var store = (0,redux.createStore)(reducers, (0,redux.applyMiddleware)(es));
...
var headerReducer_1 = __webpack_require__(3659);
var loginReducer_1 = __webpack_require__(8590);
var appReducer_1 = __webpack_require__(2144);
var Header = react_1.default.memo(function (_a) {
    var queryParams = _a.queryParams, navigationItem = _a.navigationItem, authStatus = _a.authStatus, logoutAC = _a.logoutAC, setAuthStatusAC = _a.setAuthStatusAC, getNavigationItemAC = _a.getNavigationItemAC;
    var history = react_router_dom_1.useHistory();
    ...
    var getMenuElements = function (amountElements) {
        var links = __spreadArray([], navigationItem).splice(-amountElements, amountElements);
    ...
    var getHeaderElements = function (amountElements) {
        var links = __spreadArray([], navigationItem);
        links.splice(-amountElements, amountElements);
        return links.map(function (item) { return react_1.default.createElement(react_router_dom_1.NavLink, { to: item.link, className: 'header__item', key: item.name }, item.name); });
    };
    var setAllLinksInMenu = function () {
        return navigationItem.map(function (item) { return react_1.default.createElement(react_router_dom_1.NavLink, { to: item.link, className: 'menu-container__button', key: item.name }, item.name); });
    };
    var getLengthMenuElements = function () {
        var values = 0;
    ...
    react_1.useEffect(function () {
        ...
        return function () { document.querySelector('.menu-container__menu-name').removeEventListener('click', menuHandler); };
    });
    var logout = function () {
        logoutAC();
        localStorage.clear();
...
exports.default = redux_1.compose(react_redux_1.connect(mapStateToProps, {
    getNavigationItemAC: headerReducer_1.getNavigationItemAC,
    logoutAC: loginReducer_1.logoutAC,
...
exports.default = redux_1.compose(react_redux_1.connect(mapStateToProps, {
    authentificationThunk: loginReducer_1.authentificationThunk,
}))(Login);
...
var store_1 = __importDefault(__webpack_require__(4349));
